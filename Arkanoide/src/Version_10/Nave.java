...
public class Nave extends Actor{
	...
	private static final int VIDAS_TOPE = 5;
	...
	public int getVidaActual() {
		return this.vidasActual;
	}
	public void setVidaActual(int vidasActual) {
	...
	public void mouseListener(MouseEvent e) {
		if(e.getButton() == MouseEvent.BUTTON1) {
		 Ventana.getInstancia().getBola().iniciarJuego();
		}
	}
	...
	public synchronized void keyPressed(KeyEvent e) {
		...
		switch (e.getKeyCode()) {
			...
			case KeyEvent.VK_SPACE : Ventana.getInstancia().getBola().iniciarJuego();
